...
class GeminiModel(BaseModel):
    ...
    def _convert_functions_to_gemini_format(self, openai_functions: List[Dict[str, Any]]) -> List[genai.Tool]:
        """
        ...
        # Retornar como una Tool de Gemini
        return [genai.Tool(function_declarations=gemini_functions)]
